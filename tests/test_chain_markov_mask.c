                                      ...
                                      const markov_mask_tables *t)
{
    ...
    gpu_buffer r_pos0_buf = GPU_BUFFER_NULL, r_bigram_buf = GPU_BUFFER_NULL, sizes_buf = GPU_BUFFER_NULL;
    gpu_buffer mask_len_buf = GPU_BUFFER_NULL, max_sz_buf = GPU_BUFFER_NULL;
