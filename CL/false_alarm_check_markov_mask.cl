...
#include "string.cl"
#include "rt.cl"
#include "rt_markov_mask.cl"

__kernel void false_alarm_check_markov_mask(
    ...
    __global const unsigned char *g_r_pos0,       /* ARG 16 */
    __global const unsigned char *g_r_bigram,     /* ARG 17 */
    __global const unsigned int  *g_sizes,        /* ARG 18 */
    __global unsigned int *g_mask_len,            /* ARG 19 */
    __global unsigned int *g_max_sz) {            /* ARG 20 */
