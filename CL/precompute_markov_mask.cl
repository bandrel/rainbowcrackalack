...
__kernel void precompute_markov_mask(
    ...
    __global const unsigned char *g_r_pos0,       /* ARG 15 */
    __global const unsigned char *g_r_bigram,     /* ARG 16 */
    __global const unsigned int  *g_sizes,        /* ARG 17 */
    __global unsigned int *g_mask_len,            /* ARG 18 */
    __global unsigned int *g_max_sz) {            /* ARG 19 */
