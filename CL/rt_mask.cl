/*
 * Mask-based index_to_plaintext for OpenCL.
 *
 ...
 *
 * NOTE: Position 0 is the MOST-significant digit (opposite of Markov ordering).
 * This matches the CUDA rt_mask.cu implementation.
 */
inline void index_to_plaintext_mask(
    ulong                      index,
    __global const char       *mask_data,
    __global const unsigned int *mask_lens,
