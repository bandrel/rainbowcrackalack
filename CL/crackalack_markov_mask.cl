...
__kernel void crackalack_markov_mask(
    ...
    __global const unsigned char *g_r_pos0,       /* ARG 11 */
    __global const unsigned char *g_r_bigram,     /* ARG 12 */
    __global const unsigned int  *g_sizes,        /* ARG 13 */
    __global unsigned int *g_mask_len,            /* ARG 14 */
    __global unsigned int *g_max_sz)              /* ARG 15 */
{
