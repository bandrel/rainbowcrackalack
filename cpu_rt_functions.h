...
uint64_t generate_rainbow_chain_mask(unsigned int hash_type, const Mask *mask, uint64_t plaintext_space_total, unsigned int reduction_offset, unsigned int chain_len, uint64_t start);

uint64_t generate_rainbow_chain_markov(unsigned int hash_type, const markov_model *model, unsigned int plaintext_len, unsigned int reduction_offset, unsigned int chain_len, uint64_t markov_keyspace, uint64_t start);
