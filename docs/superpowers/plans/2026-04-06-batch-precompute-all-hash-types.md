...
## Task 7: Integration test on dell3

Run an end-to-end test with 2 NetNTLMv1 hashes to verify batch precompute produces identical results to sequential.

**Files:** None (testing only)

- [ ] **Step 1: Deploy to dell3**

```bash
scp CL/*batch*.cl crackalack_lookup.c dell3:~/projects/rainbowcrackalack/
ssh dell3 'cd ~/projects/rainbowcrackalack && make clean && make linux'
```
