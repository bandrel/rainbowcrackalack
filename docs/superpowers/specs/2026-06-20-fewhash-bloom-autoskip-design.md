...
NetNTLMv1-7 hashes vs 5.0 TB / 16388 tables on gpuhost3) spends the overwhelming
majority of wall-clock building a **per-table bloom filter**, not decompressing,
reading, searching, or false-alarm-checking.

Profiling (40-table / 13 GB subset, gpuhost3):
...
- **A — integration (gpuhost3, GPU):** on the 40-table subset, a 2-hash run must
