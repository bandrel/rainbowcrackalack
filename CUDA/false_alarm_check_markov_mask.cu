...
extern "C" __global__ void false_alarm_check_markov_mask(
    ...
    const unsigned char *g_r_pos0,       /* ARG 16 */
    const unsigned char *g_r_bigram,     /* ARG 17 */
    const unsigned int  *g_sizes,        /* ARG 18 */
    unsigned int *g_mask_len,            /* ARG 19 */
    unsigned int *g_max_sz) {            /* ARG 20 */
