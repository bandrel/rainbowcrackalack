...
#define PLAINTEXT_SPACE_TOTAL 630249409724609375ULL


__device__ inline void index_to_plaintext_markov9(
...
__device__ inline unsigned long long hash_to_index_markov9(unsigned long long hash, unsigned int reduction_offset, unsigned int pos) {
  unsigned int tmp;
...
__device__ inline unsigned long long hash_char_to_index_markov9(unsigned char *hash_value, unsigned int reduction_offset, unsigned int pos) {
