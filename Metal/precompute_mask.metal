...
kernel void precompute_mask(
    ...
    device const char *g_mask_data [[buffer(15)]],
    device const unsigned int *g_mask_lens [[buffer(16)]],
    device unsigned int *g_mask_len [[buffer(17)]],
