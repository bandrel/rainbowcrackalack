...
#include "markov10_functions.metal"


kernel void precompute_markov_ntlm10(
  ...
  ulong pspace_total = *g_pspace_total;
  ulong index = hash_char_to_index_markov10(g_hash, 0, pspace_total, target_chain_len - 1);
