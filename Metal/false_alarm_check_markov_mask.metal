...
#include "shared.h"
#include "rt.metal"
#include "rt_markov_mask.metal"

kernel void false_alarm_check_markov_mask(
    ...
    constant unsigned char *g_r_pos0 [[buffer(16)]],
    constant unsigned char *g_r_bigram [[buffer(17)]],
    constant unsigned int *g_sizes [[buffer(18)]],
    device unsigned int *g_mask_len [[buffer(19)]],
    device unsigned int *g_max_sz [[buffer(20)]],
