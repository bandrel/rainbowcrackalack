...
kernel void precompute_markov_mask(
    ...
    constant unsigned char *g_r_pos0 [[buffer(15)]],
    constant unsigned char *g_r_bigram [[buffer(16)]],
    constant unsigned int *g_sizes [[buffer(17)]],
    device unsigned int *g_mask_len [[buffer(18)]],
    device unsigned int *g_max_sz [[buffer(19)]],
