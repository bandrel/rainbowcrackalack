...
kernel void crackalack_markov_mask(
    ...
    constant unsigned char *g_r_pos0 [[buffer(11)]],
    constant unsigned char *g_r_bigram [[buffer(12)]],
    constant unsigned int *g_sizes [[buffer(13)]],
    device unsigned int *g_mask_len [[buffer(14)]],
    device unsigned int *g_max_sz [[buffer(15)]],
